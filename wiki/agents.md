...
Dockerfile          # Standard Lambda image: builds lambda binary, copies posts/pages/templates/assets
Dockerfile.embed    # Embed variant: binary only + posts + pages + config.toml
